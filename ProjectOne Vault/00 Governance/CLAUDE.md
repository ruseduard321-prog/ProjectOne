...
> This note at `ProjectOne Vault/00 Governance/CLAUDE.md` is the **single authored source**. The repository-root `CLAUDE.md` is a **generated mirror** of this file, regenerated by `scripts/sync-claude-md.sh`, and must never be edited directly.
>
